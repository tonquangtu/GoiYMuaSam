...
//
    ...
    @GET(ServerLink.LINK_LOGIN)
    Call<GetListProductData> callGetProductListInAd(@QueryMap Map<String, String> tag);
    ...
    @GET(ServerLink.LINK_LOGIN)
    Call<GetListProductData> callGetProductListInSales(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<GetListProductData> callGetProductListInCatalog(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<GetSuggestSearchPro> callGetSuggestSearchPro(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<GetSuggestSearchShop> callGetSuggestSearchShop(@QueryMap Map<String,String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<GetListProductData> callSearchProduct(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<GetShopListData> callSearchShop(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<ResponseFromServerData> callUserViewProduct(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<ResponseFromServerData> callUserViewShop(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<ResponseFromServerData> callSentLike(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<ResponseFromServerData> callLogin(@QueryMap Map<String, String> tag);

    @GET(ServerLink.LINK_LOGIN)
    Call<ResponseFromServerData> callPin(@QueryMap Map<String, String> tag);

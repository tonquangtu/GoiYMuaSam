...
import com.mycompany.mainui.adapter.RecyclerAdapterRecommend;
...
//        SpaceItem space = new SpaceItem(30,40);
        ...
        adapterRecommend.setOnItemClickListener(new RecyclerAdapterRecommend.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int position) {
                ...
                if(shortProduct != null) {
                    suggestionController.handleClickProductSuggestion(context, shortProduct.getIdProduct(),
                            shortProduct.getProductName());
                }
            }
        });

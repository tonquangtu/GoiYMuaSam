...
import com.mycompany.mainui.network.LoadProductListInCatalog;
 ...
 */
public class FragmentProductListInCatalog extends Fragment {


    ProductListInCatalogActivity activity;
    RecyclerView recyclerView;
    SwipeRefreshLayout refreshLayout;
    LoadProductListInCatalog loadProduct;
    ...
    public static FragmentProductListInCatalog newInstance(LoadProductListInCatalog loadProductHot,
                                                           int mToolContainerHeight,
                                                           String catalog) {

        FragmentProductListInCatalog fragment = new FragmentProductListInCatalog();
        Bundle args = new Bundle();
        args.putSerializable(ARG_LOAD_PRODUCT, loadProductHot);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activity = (ProductListInCatalogActivity)getActivity();
        Bundle args = getArguments();
        loadProduct = (LoadProductListInCatalog)args.getSerializable(ARG_LOAD_PRODUCT);
        mToolContainerHeight = args.getInt(ARG_TOOL_HEIGHT);
        catalog = args.getString(ARG_CATALOG);

        listData = loadProduct.getListData();
        isLoading = false;
        isRefresh = false;
    }
            ...
            if(StatusInternet.isInternet(activity)) {
                ...
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        loadProduct.loadProducts(activity,catalog);

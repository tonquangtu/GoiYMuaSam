 ...
 */
public class FragmentProductListInSales extends Fragment {

    ProductListInSalesActivity activity;
    RecyclerView recyclerView;
    SwipeRefreshLayout refreshLayout;
    LoadProductListInSales loadProduct;
    public static final String ARG_LOAD_PRODUCT_SALES = "ARG_LOAD_PRODUCT_SALES";
    ...
    public static FragmentProductListInSales newInstance(LoadProductListInSales loadProduct,
                                                              int mToolContainerHeight) {

        FragmentProductListInSales fragment = new FragmentProductListInSales();
        Bundle args = new Bundle();
        args.putSerializable(ARG_LOAD_PRODUCT_SALES, loadProduct);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activity = (ProductListInSalesActivity) getActivity();
        Bundle args = getArguments();
        loadProduct = (LoadProductListInSales) args.getSerializable(ARG_LOAD_PRODUCT_SALES);
        mToolContainerHeight = args.getInt(ARG_TOOL_HEIGHT);

        listData = loadProduct.getSalesList();
        isLoading = false;
        isRefresh = false;
    }
    ...
    public synchronized void handleOnLoadMore() {
        ...
        if(!loadProduct.getMessage().equals(RequestId.MES_NOTHING)) {
            if(StatusInternet.isInternet(activity)) {
                ...
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        loadProduct.loadProductListInSales(activity);
                        while(!loadProduct.isLoadComplete()) {

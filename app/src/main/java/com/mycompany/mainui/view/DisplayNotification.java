...
public class DisplayNotification {
    ...
    public static void errorLoaddata(Activity context) {
        Toast.makeText(context, "Error, khong the tai duoc du lieu", Toast.LENGTH_LONG).show();
    }

    public static void errorLoaddata(Activity context, String message) {
        Toast.makeText(context, "Error ,khong the tai duoc du lieu : " + message, Toast.LENGTH_LONG).show();
    }

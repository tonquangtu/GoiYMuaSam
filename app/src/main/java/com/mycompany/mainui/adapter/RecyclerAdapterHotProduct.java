...
public class RecyclerAdapterHotProduct extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
 ...
 ;
    ...
    public RecyclerAdapterHotProduct(final Context context, final ArrayList<Object> datas
    ...
    public int getItemViewType(int position) {
        ...
        else if(listData.get(position) == null){
            return VIEW_PROG;
        }
        else return VIEW_TITLE;
    }

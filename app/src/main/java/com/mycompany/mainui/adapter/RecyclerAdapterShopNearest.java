...
public class RecyclerAdapterShopNearest extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerAdapterShopNearest(Context context, final ArrayList<ShortShop> data
        ...
        if (recyclerView.getLayoutManager() instanceof LinearLayoutManager) {
            ...
            recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    int totalItemCount = listData.size();
                    int lastVisibleItem = linearLayoutManager.findLastVisibleItemPosition();
                    if (dy > DISTANCE_SWIPE && totalItemCount <= (lastVisibleItem + visibleThreshold)) {
...
//            LoadImageFromUrl.loadImageFromResourse(R.drawable.icon_view1, viewHolder.icon_view, context);

            viewHolder.note.setText(data.getNote());
            viewHolder.number_view.setText(data.getNumOfView() + TAG_NUM_VIEW);

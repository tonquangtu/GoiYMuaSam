...
//    private final int VIEW_PROG = 0;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof ProductHolder){
            ...
            final ProductHolder hd = (ProductHolder) holder;
            ...
            StaggeredGridLayoutManager.LayoutParams layoutParams
                    ...
                    titleHolder.itemView.getLayoutParams();
            layoutParams.setFullSpan(true);


            titleHolder.title.setText(catalog);

            titleHolder.more.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(listener != null) {
                        listener.onItemClick(titleHolder.itemView, position);
                    }
                }
            });
           ...
           final ShopHolder hd = (ShopHolder)holder;
            StaggeredGridLayoutManager.LayoutParams layoutParams
                    = (StaggeredGridLayoutManager.LayoutParams)

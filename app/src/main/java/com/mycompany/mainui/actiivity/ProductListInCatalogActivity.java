...
import com.mycompany.mainui.fragment.FragmentProductListInCatalog;
...
public class ProductListInCatalogActivity extends AppCompatActivity {

    ProductListInCatalogActivity mActivity;
    LoadProductListInCatalog loadProductListInCatalog;
    ActionBar actionBar;
    String catalogName;
    Toolbar toolbar;
...
//    FragmentFilterSales fragmentFilterSales;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catalogName = bundle.getString(ConfigData.ARG_PRODUCT_CATALOG);

        mActivity = this;
        loadProductListInCatalog = new LoadProductListInCatalog();
...
//        adapterSales = new FilterAdapter(this, R.layout.row_filter, listTitleFilterSales);
    ...
    public class LoadTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            loadProductListInCatalog.loadProducts(mActivity, catalogName);
            while(!loadProductListInCatalog.isLoadComplete()) {
                SystemClock.sleep(ConfigData.TIME_SLEEP);
            }
            loadProductListInCatalog.addLoadMore();
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            FragmentProductListInCatalog fragment = FragmentProductListInCatalog
                    .newInstance(loadProductListInCatalog, mToolContainerHeight, catalogName);

...
import com.mycompany.mainui.fragment.FragmentProductListInSales;
...
import com.mycompany.mainui.network.LoadProductListInSales;

import java.util.ArrayList;

public class ProductListInSalesActivity extends AppCompatActivity {

    ProductListInSalesActivity mActivity;
    LoadProductListInSales loadProductListInSales;
...
//    FragmentFilterSales fragmentFilterSales;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listProduct = (ArrayList<ShortProduct>) bundle.getSerializable(ConfigData.ARG_SALES_PRODUCT_LIST);

        mActivity = ProductListInSalesActivity.this;
        loadProductListInSales = new LoadProductListInSales(listProduct);
        ...
        Toast.makeText(this, "sales : " + mToolContainerHeight, Toast.LENGTH_SHORT).show();
...
//        adapterSales = new FilterAdapter(this, R.layout.row_filter, listTitleFilterSales);
    ...
    // handle reloading product in here
    ...
    public class LoadTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            loadProductListInSales.loadProductListInSales(mActivity);
            while(!loadProductListInSales.isLoadComplete()) {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            FragmentProductListInSales fragmentSales = FragmentProductListInSales
                    .newInstance(loadProductListInSales, mToolContainerHeight);

            ft.replace(R.id.product_list_in_catalog_place_holder, fragmentSales);
            ft.commit();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(final String query) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        SuggestionDbUtil.addRowSuggestion(ProductListInSalesActivity.this, query.trim());
                    }
                }).start();
                return false;
            }
